...
let CATEGORIES  = [];let NUM_CATEGORIES = [];
let board = [];
let HEIGHT = 5;
let WIDTH = 5;
...
async function fillTable() {
    ...
    const body = doucument.queryySelector("body");
    
    body.append(table);

    table.clastList.add("center");
